...
int main(int argc, char *argv[])
{
  ...
  printf("on écrit \"2222\" plus loin dans la deuxième page du mmap2\n");
  memcpy(map2+4096+4, "2222", 4);
  printf("on écrit \"1111\" dans la deuxième page du mmap1\n");
  memcpy(map1+4096, "1111", 4);
