...
int main(int argc, char *argv[])
{
  ...
  map2 = mmap(NULL, LENGTH, PROT_READ|PROT_WRITE, MAP_PRIVATE, fd, 0);
  ...
  printf("on écrit \"2222\" peu après le début de la deuxième page de map2\n");
  memcpy(map2+4098, "2222", 4);
  printf("on écrit \"111111\" à cheval sur les pages de mmap1\n");
  memcpy(map1+4094, "1111", 4);
